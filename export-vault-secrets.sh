...
if test -f /var/run/secrets/nais.io/permittering-api/altinn-header/altinnkey
then
    export  ALTINN_HEADER=$(cat /var/run/secrets/nais.io/permittering-api/altinn-header/altinnkey)
